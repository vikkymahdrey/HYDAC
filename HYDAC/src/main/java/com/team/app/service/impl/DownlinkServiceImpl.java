...
public class DownlinkServiceImpl implements DownlinkService {
			...
			//if(frm!=null){
				...
				byte[] byteArr = new byte[7];
				 ...
				 SimpleDateFormat formatDay = new SimpleDateFormat("dd");
				 	formatDay.setTimeZone(TimeZone.getTimeZone("IST"));
				 SimpleDateFormat formatMonth = new SimpleDateFormat("MM");
				 	formatMonth.setTimeZone(TimeZone.getTimeZone("IST"));
				 SimpleDateFormat formatYear = new SimpleDateFormat("YY");
				 	formatYear.setTimeZone(TimeZone.getTimeZone("IST"));
				 SimpleDateFormat datetimestamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
				   ...
				   String currentDay = formatDay.format(new Date(System.currentTimeMillis()));
				    ...
				    Date dateTmStmp=DateUtil.getCurrentDateTimeIST();
	   				...
	   				int responseCode = con.getResponseCode();
	   					logger.debug("POST Response Code :: " + responseCode);
	   						...
	   						if(responseCode==200) {
	   							...
	   							q=new DownlinkQueue();
	   							q.setDevEui(devEUI);
	   							q.setApplicationID(applicationID);
	   							q.setFport(fport);
	   							q.setData(Base64.encodeBase64String(byteArr));
	   							q.setCreatedAt(DateUtil.getCurrentDateTimeIST());
	   							q.setUpdatedAt(DateUtil.getCurrentDateTimeIST());
	...
	public String doDownlinkForAllInOne(String devEUI, String applicationID, String fport) throws Exception {
		String returnVal="";
		logger.debug("In doDownlinkForRetry");
		try{			
				byte[] byteArr = new byte[1];									
				byteArr[0]=Byte.valueOf(AppConstants.allInOne);
				...
				try{
				 ...
				 JSONObject jsonObj=null;
					...
					jsonObj.put("devEUI",devEUI);
					jsonObj.put("fPort",fPort);
					jsonObj.put("reference","AllInOneSetting");
