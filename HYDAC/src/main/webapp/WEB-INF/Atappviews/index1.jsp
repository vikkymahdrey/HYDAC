...
<div class="login-box">
  ...
  <div class="login-box-body" style="border-radius: 25px;border-style: solid;border-width: thin;border-color:white;background-color:#235E93">
    <p class="login-box-msg" style="color:white">
     <a href="#">
    <img src="dashboard/dist/img/hydac.png" class="user-image" alt="User Image" width="50px" height="50px">
    <b style="color:white;font-family:Gabriola;font-size:4px"></b></a>
    ...
    <form action="onSubmitlogin" name="user_validation_form" id="user_validation_form" method="post" onsubmit="return validate()">
			      ...
			      <div class="row" style="text-align:center;">
				        ...
				        <div class="col-xs-6">
				          <button type="submit" style="border-radius: 10px;background-color:#64B246;box-shadow: 0px 0px 2px 2px rgba(0,0,0,0.10);border:0" class="btn btn-primary btn-block btn-flat text-bold">Sign In</button>
				        </div>
				        <!-- /.col -->
			      </div>
