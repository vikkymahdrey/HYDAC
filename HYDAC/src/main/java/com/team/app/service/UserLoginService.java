...
public interface UserLoginService {
	...
	void changePwd(TblUserInfo userInfo)throws AtAppException;

	TblUserInfo setPwd(TblUserInfo user)throws AtAppException;
	List<UserDeviceMapping>  getUserDeviceOrgId(String userId)throws AtAppException;

	TblPushNotifications getNotificationInfoByUserId(String userId)throws Exception;

	void persistPushNotification(TblPushNotifications ps)throws Exception;

	List<TblHydacInfo> getHydacInfos()throws Exception;
