...
<html lang="en">
  <head>
    ...
    <title>Remove Consoildated Data</title>
...
{     
    ...
    var url="getConsoildatedDev?appId="+appid;                                    
	...
	<div class="content-wrapper">
			...
			<section class="content">
		 		...
		 		<div class="box-header with-border">
  					  <h5 class="text-blue text-left "><span class="fa fa-recycle"></span>&nbsp;&nbsp;<b>Remove Consoildated Data </b></h5>
