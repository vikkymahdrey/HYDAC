...
public class AppConstants {
	...
	//public static final String domain = "https://130.61.50.175:8080";
	//public static final String appURL = "http://130.61.50.175:8081/USWMDEMO";
	...
	//public static final String noportdomain = "130.61.50.175";
	...
	public static final String allInOne = "5";
	...
	// public static final String base_url = "https://secure.payu.in";
	...
	public static final String complaintsuccess = "success";
	public static final String complaintfailed = "fail";
	public static final String phonetype = "web";

	// Packet Type

	public static final String normal = "N";
	public static final String consoildated = "C";
