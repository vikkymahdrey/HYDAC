	   ...
	   var orgid=document.getElementById("orgid").value;
 	   ...
 	   if(orgid=="0"){
		   ...
		   return false;
			...
			alert("Username must be 4 - 32 characters long, contain only letters, numbers and _ ");
		   ...
		   $.ajax({
	           ...
	           success: function (data) {	        	          		
		        	   if(data=='success'){
		        		   ...
		        		   //window.location="http://130.61.50.175:8081/USWMDEMO/userReport";
