...
public class ConsumerInstrumentServiceImpl implements ConsumerInstrumentService {
	...
	@Autowired
	private  ConsumptionsLtrDao consumptionsLtrDao; 
	...
	public Object[] getTotalWeeklyIntervalWaterConsumptions(Date sDt,Date eDt, String appId, String devEUI, String interval)
			throws Exception {
		return frameDao.getTotalWeeklyIntervalWaterConsumptions(sDt,eDt,appId,devEUI,interval);
	}

	
	public List<TblLoraConsoildatedPkt> getConsoildatedDevInfoByAppId(String appId) throws Exception {
		return loraConsoildatedPktDao.getConsoildatedDevInfoByAppId(appId);
	}

	
	public void deleteConsoildatedInfo(String appId, String devEUI) throws Exception {
		loraConsoildatedPktDao.deleteConsoildatedInfo(appId,devEUI);
		
	}

	public String getPasswordResetMessage(TblUserInfo user) throws Exception {
		return  "Hi "
				+user.getUname()	
				+",<br/><br/>I heard that you forgot your USWM account password. Fear not, I'm here to help."
				+"<br/><br/>I've generated a new password for you below."
				+"<br/><br/>Username - "+user.getUname()
				+"<br/>Password - "+user.getPassword()
				+"<br/><br/>If you need help with anything else check out our Help Center or email me directly at <a href='vikky@unizentechnologies.com'>vikky@unizentechnologies.com</a>."
				+"<br/><br/>Much love,"
				+"<br/>Unizen"
				+"<br/>Support Manager";
	...
	public TblConsumptionsConfig getConsumptionsConfigByDevId(String devEUI) throws Exception {	
		return consumptionsLtrDao.getConsumptionsConfigByDevId(devEUI);
	}

	
	public TblHydacInfo save(TblHydacInfo hydac) throws Exception {
		return hydacDao.save(hydac);
	}

	public List<TblHydacInfo> getHydacDevices() throws Exception {
		return hydacDao.getHydacDevices();
	}

	
	public List<TblHydacInfo> getHydacInfo() throws Exception {
			return hydacDao.getHydacInfo();
	}
