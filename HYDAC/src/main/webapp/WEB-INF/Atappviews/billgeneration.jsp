...
{     
	...
	if(appid=="0")
    	...
    	{
    var url="generatebill?appId="+appid+"&orgId="+orgId+"&fromDate="+fromdate+"&toDate="+todate                                    
...
<td><input type="date" id="todate"/>
									...
									<input type="button"
										...
										value="Generate Bills" /> <!-- 					<form method="post" action="userUpload"enctype="multipart/form-data">
 -->  <!-- </form> -->
 </td>
								</tr>
