...
<html lang="en">
  <head>
    ...
    <title>Delete Downlink Queue</title>
	...
	<div class="content-wrapper">
			...
			<section class="content">
		 		...
		 		<div class="box-header with-border">
  					  <h5 class="text-blue text-left "><span class="fa fa-recycle"></span>&nbsp;&nbsp;<b>Delete Downlink Queue </b></h5>
    				    	...
    				    	<form name="form1" action="syncDev" onsubmit="return confirmValidate();" method="post">
								  ...
								  <tr>								  		
									...
									<tr>	
									   <td align="right"><b>Start Id</b></td>
									   
										 <td>
										 	<input type="text" class="form-control" name="startId" id="startId" placeholder="Queue Starting ID"/>
										</td>
									</tr>
									
									<tr>	
									   <td  align="right"><b>End Id</b></td>
									   
										 <td>
										 	<input type="text" class="form-control" name="endId" id="endId" placeholder="Queue Ending ID"/>
										</td>
									</tr>
									<tr>	
										<td align="center"></td>
											<td> <input type="button"   style="background-color:#3c8dbc;color:white; " value="View" onclick="getDownlinkQueue()"/></td>
											<td> <input type="submit"   style="background-color:#3c8dbc;color:white; " value="Delete"/></td>
