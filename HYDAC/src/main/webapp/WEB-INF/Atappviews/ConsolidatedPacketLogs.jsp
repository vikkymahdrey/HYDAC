...
<head>
  ...
  <title>Consolidated packet logs</title>
...
<% 
						...
						List<TblLoraConsoildatedPkt> frames=(List<TblLoraConsoildatedPkt>)request.getAttribute("frames");
						%>
   ...
   <div class="box">
    <div class="box-body">
        ...
        <%--      <display:table    name="<%=frames%>"  
                id="example1" class="table table-bordered table-striped dataTable" export="true" requestURI="" defaultsort="1" defaultorder="descending" pagesize="50">
							...
							<display:column  property="startRange" title="Frame_Start_Ref" sortable="true"  />	
							<display:column  property="endRange" title="Frame_End_Ref" sortable="true"  />		
                ...
                <tr role="row" style="background-color:#24659F;color:#ffff;">
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 251px;">WaterMeterName</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 198px;">WaterMeter</th>
                ...
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 145px;">Water_liters</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 145px;">Frame_Start_Ref</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 145px;">Frame_End_Ref</th>
                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 145px;">devMapId</th>
               ...
               <!--  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 145px;">View</th> -->
                ...
                <td><%=frames.get(i).getStatus()%></td>
                <td><%=frames.get(i).getWaterltr()%></td>
                <td><%=frames.get(i).getStartRange()%></td>
                <td><%=frames.get(i).getEndRange()%></td>
                <td><%=frames.get(i).getDevMapId()%></td>
                <td><%=frames.get(i).getCreatedDt()%></td>
                </tr>
              <%   }%>
               </tbody>
